...
class ChatViewController: MessagesViewController {
    ...
    func loadChat() {
        ...
        let db = Firestore.firestore().collection("Chats").whereField("users", arrayContains: "1234"/*Auth.auth().currentUser?.uid*/ ?? "Not Found User 1")
            ...
            if let error = error {
                ...
                if queryCount == 0 {
                    ...
                    for doc in chatQuerySnap!.documents {
                        ...
                        if (chat?.users.contains("1234"/*self.user2UID!*/))! {
    ...
    func createNewChat() {
        let users = ["1234"/*self.currentUser.uid*/, self.user2UID]
        let data: [String: Any] = [
            "users":users
        ]
...
extension ChatViewController: InputBarAccessoryViewDelegate {
    func inputBar(_ inputBar: InputBarAccessoryView, didPressSendButtonWith text: String) {
        ...
        let message = Message(id: UUID().uuidString, content: text, created: Timestamp(), senderID: "1234"/*currentUser.uid*/, senderName: "batatinha"/*currentUser.displayName!*/)
